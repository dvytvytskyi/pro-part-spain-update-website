...
export default function Secondary() {
    const { t } = useLanguage();
    const { filters, setFilters, currentPage, setPage, clearFilters } = usePropertyFilters('secondary', INITIAL_DEFAULTS);
        ...
        const fetchProperties = async () => {
            ...
            try {
                ...
                if (!isCancelled) {
                    ...
                    // Final safety filter for town matches (Accent Insensitive)
                ...
                if (!isCancelled) {
                    console.error('Failed to load secondary properties:', error);
                }
            } finally {
                if (!isCancelled) {
                    setIsLoading(false);
    ...
    // Simple sorting - backend is faster, but we keep this as a fallback or for client-side items
            ...
            <main className="main-content">
                <div className="container">
                    <div className="listing-header">
                        <h2 className="listing-title">{t('pages.secondary.title')}</h2>
